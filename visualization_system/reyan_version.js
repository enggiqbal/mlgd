...
import clusterData from './geojson/reyan_topics/im_cluster.geojson'
import clusterBoundaryData from './geojson/reyan_topics/im_cluster_boundary.geojson'
import edgeyData from './geojson/reyan_topics/im_edges.geojson'
import nodeData from './geojson/reyan_topics/im_nodes.geojson'
...
function getVisible(l,resolution)
{
  ...
  var visiable=false
  if (l == 1 && resolution< 15)  visiable= true;
