...
import clusterData from './geojson/reyan_topics_10_layers/im_cluster.geojson'
import clusterBoundaryData from './geojson/reyan_topics_10_layers/im_cluster_boundary.geojson'
import edgeyData from './geojson/reyan_topics_10_layers/im_edges.geojson'
import nodeData from './geojson/reyan_topics_10_layers/im_nodes.geojson'
...
function getVisible(l,resolution)
{
  ...
  var visiable=false
  if (l == 1 && resolution< 9)  visiable= true;
  if (l == 2 && resolution< 8) visiable= true;
  if (l == 3 && resolution< 7)  visiable= true;
  if (l == 4 && resolution< 6)   visiable= true;
  if (l == 5 && resolution< 6.5)  visiable= true;
  if (l == 6 && resolution< 5)  visiable= true;
  if (l == 7 && resolution< 4)  visiable= true;
  if (l == 8 && resolution< 3)  visiable= true;
  if (l == 9 && resolution< 2) visiable=true;
  if(l == 10 && resolution< 1) visiable=true;
  return visiable
}
