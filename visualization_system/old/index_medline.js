...
import clusterData from './geojson/impred_medline/im_cluster.geojson'
import clusterBoundaryData from './geojson/impred_medline/im_cluster_boundary.geojson'
import edgeyData from './geojson/impred_medline/im_edges.geojson'
import nodeData from './geojson/impred_medline/test_title.geojson'
import allEdges from './geojson/impred_medline/im_alledges.geojson'
...
function getVisible(l,resolution)
{
  ...
  if (l == 2 && resolution< 25) visiable= true;
  if (l == 3 && resolution< 20)  visiable= true;
  if (l == 4 && resolution< 15)   visiable= true;
  if (l == 5 && resolution< 10)  visiable= true;
  if (l == 6 && resolution< 8)  visiable= true;
  if (l == 7 && resolution< 7)  visiable= true;
  if (l == 8 && resolution< 6)  visiable= true;
  return visiable
}
...
map.on('click', function(evt) {
  ...
  var feature = map.forEachFeatureAtPixel(evt.pixel,
      ...
      if (feature) {
       ...
       var content =   "Title: " + feature.get('title') + " <br> Weight: " +  feature.get('weight')  ;
