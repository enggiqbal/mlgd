...
function getVisible(l,resolution)
{
  ...
  if (l == 5 && resolution< 12)  visiable= true;
  if (l == 6 && resolution< 10)  visiable= true;
  if (l == 7 && resolution< 8)  visiable= true;
...
var createTextStyle = function(lbl, fontsize, level, boxheight,weight,resolution) {
  ...
  if (level==1 && resolution> 30){
    fsize=fontsize*30 / resolution ;
  }
  var nodetext=
